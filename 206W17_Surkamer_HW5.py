...
CACHE_file = "twitter_phrase.json"
try: 
	cache_file_1 = open(CACHE_file,'r')
	cache_content = cache_file_1.read()
	CACHE_DICTION = json.loads(cache_contents)
except: 
	CACHE_DICTION = {}

phrase_to_find = input("Enter phrase for twitter to search for:")
